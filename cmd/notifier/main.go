...
func main() {
	app := cli.NewApp()
	app.Name = "SUI sovereign chain notifier"
	app.Usage = "The SUI Notifier is a Go-based application designed to bridge SUI and a MultiversX sovereign" +
		" chain by monitoring SUI blockchain events and relaying them to the sovereign chain in real-time." +
